...
class Result
{
    ...
    // This solution pretty much using the simple bruteforce check up
    
    public static int formingMagicSquare(List<List<int>> s)
    {
        // All 8 possible 3x3 magic squares (rotations and reflections)
        // We'll check from them write one and calculte the "min cost"
    int[][][] magicSquares = new int[][][]
    {
        ...
        int minCost = int.MaxValue; // whenever finding one smaller will update it
        
        foreach( var magic in magicSquares){ // var like auto in c++ getting the type of the argument 
